...
* Your contribution here.
* [#1836](https://github.com/ruby-grape/grape/pull/1836): Addresses memory issue due to storing in memory and not releasing `call` method calls - [@myxoh](https://github.com/myxoh).
