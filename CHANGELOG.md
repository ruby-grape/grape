...
* [#2969](https://github.com/ruby-grape/grape/pull/2969): Correct the README on which name `given` takes for a param renamed with `as` - [@ericproulx](https://github.com/ericproulx).
* Your contribution here.
