...
* [#1904](https://github.com/ruby-grape/grape/pull/1904): [autoload] Allows Grape to load files on startup rather than on the first call - [@myxoh](https://github.com/myxoh).
