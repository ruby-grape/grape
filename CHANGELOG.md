...
* [#2928](https://github.com/ruby-grape/grape/pull/2928): Settle the attributes iterator's per-scope state once per pass instead of once per array element - [@ericproulx](https://github.com/ericproulx).
* Your contribution here.
