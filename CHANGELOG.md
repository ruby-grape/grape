...
#### Features
* [#669](https://github.com/intridea/grape/pull/669)Added support for crud_resources, allowing the 7 typical crud routes to be added with a single line - @Halloran(https://github.com/halloran)
