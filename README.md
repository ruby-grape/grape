...
You're reading the documentation for the next release of Grape, which should be 0.16.1.
Please read [UPGRADING](UPGRADING.md) when upgrading from a previous version.
The current stable release is [0.16.0](https://github.com/ruby-grape/grape/blob/v0.16.0/README.md).
