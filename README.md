...
You're reading the documentation for the next release of Grape, which should be 0.15.1.
Please read [UPGRADING](UPGRADING.md) when upgrading from a previous version.
The current stable release is [0.15.0](https://github.com/ruby-grape/grape/blob/v0.15.0/README.md).
