...
module Grape
  ...
  class Endpoint
    ...
    def initialize(new_settings, options = {}, &block)
      ...
      route_setting(:declared_params_with_scope, namespace_stackable(:declared_params_with_scope).flatten)
    ...
    def inherit_settings(namespace_stackable)
      ...
      parent_declared_params_with_scope = namespace_stackable[:declared_params_with_scope]

      inheritable_setting.route[:declared_params].concat(parent_declared_params.flatten) if parent_declared_params
      inheritable_setting.route[:declared_params_with_scope].concat(parent_declared_params_with_scope.flatten) if parent_declared_params_with_scope
    ...
    def prepare_default_route_attributes
      {
        ...
        settings: inheritable_setting.route.except(:declared_params, :declared_params_with_scope, :saved_validations),
