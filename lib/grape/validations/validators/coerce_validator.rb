  ...
  module Validations
    module Validators
      class CoerceValidator < Base
        ...
        # @converter is intentionally left mutable — coercers built by
        # Types.build_coercer may lazily memoize internal state at call time.
        # No freeze_state! override is needed: deep_freeze already skips
        # non-Hash/Array/String objects, so @converter is left unfrozen automatically.
