...
*(only applicable if Grape::Extensions::Hash::ParamBuilder is used)*

`route_param` takes higher precedence over a regular parameter defined with same name. This is the original behavior
that was changed in v1.8.0:
